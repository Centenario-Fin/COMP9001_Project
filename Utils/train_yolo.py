...
# model setting 
MODEL_NAME = 'yolov8n-pose.yaml' #change yaml to pt to get better result by using pretrain model
EPOCHS = 500
BATCH_SIZE = 10
IMG_SIZE = 640
PROJECT_NAME = 'Try'
...
with open(YAML_FILE_PATH, 'w') as f: # use write model open the yaml file. write the new status in it 
    # change the python file method to the yaml format but with all ori detail. 
